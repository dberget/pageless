defmodule PagelessWeb.Auth do
  ...
  and assigns it to the `current_user` key. If company is not specified or user is
  ...
  - If company is not specified, halts and returns a 400 response.
